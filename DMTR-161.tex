...
\href{https://jira.lsstcorp.org/secure/Tests.jspa#/testCase/LVV-T1436}{LVV-T1436}
    ...
    \begin{minipage}[]{9cm}
    \smallskip
    Firefox 70.0.1 was used on OS X 10.11.6 on a machine on the IPAC
internal network. ~No VPN connection was required.
...
Final comment:\\Firefox 70.0.1 was used on OS X 10.11.6 on a machine on the IPAC
internal network. ~No VPN connection was required.
...
version being 0.5.3) in order to avoid a token-validation failure.
